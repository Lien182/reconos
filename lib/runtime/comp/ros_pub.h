 ...
 */
extern int ros_publisher_init(struct ros_publisher *ros_pub, char* topic, uint32_t max_msg_size);
 ...
 *   mb - pointer to the mbox
 */
extern void ros_publisher_destroy(struct ros_publisher *ros_pub);
 ...
 */
extern int ros_publisher_publish(struct ros_publisher *ros_pub, uint8_t * msg);
