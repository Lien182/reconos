...
# HDMI Output - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN W18  [get_ports {hdmi_out_clk}];  # "HD-CLK"
set_property PACKAGE_PIN Y13  [get_ports {hdmi_16_data[0]}];  # "HD-D0"
set_property PACKAGE_PIN AA13 [get_ports {hdmi_16_data[1]}];  # "HD-D1"
set_property PACKAGE_PIN W13  [get_ports {hdmi_16_data[10]}];  # "HD-D10"
set_property PACKAGE_PIN W15  [get_ports {hdmi_16_data[11]}];  # "HD-D11"
set_property PACKAGE_PIN V15  [get_ports {hdmi_16_data[12]}];  # "HD-D12"
set_property PACKAGE_PIN U17  [get_ports {hdmi_16_data[13]}];  # "HD-D13"
set_property PACKAGE_PIN V14  [get_ports {hdmi_16_data[14]}];  # "HD-D14"
set_property PACKAGE_PIN V13  [get_ports {hdmi_16_data[15]}];  # "HD-D15"
set_property PACKAGE_PIN AA14 [get_ports {hdmi_16_data[2]}];  # "HD-D2"
set_property PACKAGE_PIN Y14  [get_ports {hdmi_16_data[3]}];  # "HD-D3"
set_property PACKAGE_PIN AB15 [get_ports {hdmi_16_data[4]}];  # "HD-D4"
set_property PACKAGE_PIN AB16 [get_ports {hdmi_16_data[5]}];  # "HD-D5"
set_property PACKAGE_PIN AA16 [get_ports {hdmi_16_data[6]}];  # "HD-D6"
set_property PACKAGE_PIN AB17 [get_ports {hdmi_16_data[7]}];  # "HD-D7"
set_property PACKAGE_PIN AA17 [get_ports {hdmi_16_data[8]}];  # "HD-D8"
set_property PACKAGE_PIN Y15  [get_ports {hdmi_16_data[9]}];  # "HD-D9"
set_property PACKAGE_PIN U16  [get_ports {hdmi_16_data_e}];  # "HD-DE"
set_property PACKAGE_PIN V17  [get_ports {hdmi_16_hsync}];  # "HD-HSYNC"
set_property PACKAGE_PIN W16  [get_ports {HD_INT}];  # "HD-INT"
set_property PACKAGE_PIN AA18 [get_ports {iic_scl_io}];  # "HD-SCL"
set_property PACKAGE_PIN Y16  [get_ports {iic_sda_io}];  # "HD-SDA"
set_property PACKAGE_PIN U15  [get_ports {HD_SPDIF}];  # "HD-SPDIF"
set_property PACKAGE_PIN Y18  [get_ports {HD_SPDIFO}];  # "HD-SPDIFO"
set_property PACKAGE_PIN W17  [get_ports {hdmi_16_vsync}];  # "HD-VSYNC"
...
set_property PACKAGE_PIN V22 [get_ports {LD4[0]}];  # "LD4"
...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN P16 [get_ports {gpio_btn_tri_i[0]}];  # "BTNC"
set_property PACKAGE_PIN R16 [get_ports {gpio_btn_tri_i[1]}];  # "BTND"
set_property PACKAGE_PIN N15 [get_ports {gpio_btn_tri_i[2]}];  # "BTNL"
set_property PACKAGE_PIN R18 [get_ports {gpio_btn_tri_i[3]}];  # "BTNR"
set_property PACKAGE_PIN T18 [get_ports {gpio_btn_tri_i[4]}];  # "BTNU"
...
## ---------------------------------------------------------------------------- 
set_property -dict {PACKAGE_PIN F22 IOSTANDARD LVCMOS25}  [get_ports {SW0}];  # "SW0"
#set_property PACKAGE_PIN G22 [get_ports {gpio_sw_tri_i[1]}];  # "SW1"
#set_property PACKAGE_PIN H22 [get_ports {gpio_sw_tri_i[2]}];  # "SW2"
#set_property PACKAGE_PIN F21 [get_ports {gpio_sw_tri_i[3]}];  # "SW3"
#set_property PACKAGE_PIN H19 [get_ports {gpio_sw_tri_i[4]}];  # "SW4"
#set_property PACKAGE_PIN H18 [get_ports {gpio_sw_tri_i[5]}];  # "SW5"
#set_property PACKAGE_PIN H17 [get_ports {gpio_sw_tri_i[6]}];  # "SW6"
#set_property PACKAGE_PIN M15 [get_ports {gpio_sw_tri_i[7]}];  # "SW7"
...
## ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN R7 [get_ports {iic_1_scl_io}];  # "FMC-SCL"
set_property PACKAGE_PIN U7 [get_ports {iic_1_sda_io}];  # "FMC-SDA"
...
#set_property PACKAGE_PIN M20 [get_ports {vid_data[23]}];  # "FMC-LA00_CC_N"
set_property -dict {PACKAGE_PIN M19 IOSTANDARD LVCMOS25} [get_ports {hdmi_rx_clk}];  # "FMC-LA00_CC_P"
...
#set_property PACKAGE_PIN P18 [get_ports {vid_data[21]}];  # "FMC-LA02_N"
#set_property PACKAGE_PIN P17 [get_ports {vid_data[22]}];  # "FMC-LA02_P"
#set_property PACKAGE_PIN P22 [get_ports {vid_data[19]}];  # "FMC-LA03_N"
#set_property PACKAGE_PIN N22 [get_ports {vid_data[20]}];  # "FMC-LA03_P"
#set_property PACKAGE_PIN M22 [get_ports {vid_data[17]}];  # "FMC-LA04_N"
#set_property PACKAGE_PIN M21 [get_ports {vid_data[18]}];  # "FMC-LA04_P"
...
set_property -dict {PACKAGE_PIN T17 IOSTANDARD LVCMOS25     IOB TRUE} [get_ports {hdmi_rx_data[5]}];  # "FMC-LA07_N"
set_property -dict {PACKAGE_PIN T16 IOSTANDARD LVCMOS25     IOB TRUE} [get_ports {hdmi_rx_data[7]}];  # "FMC-LA07_P"
set_property -dict {PACKAGE_PIN J22 IOSTANDARD LVCMOS25     IOB TRUE} [get_ports {hdmi_rx_data[6]}];  # "FMC-LA08_N"
#set_property PACKAGE_PIN J21 [get_ports {vid_data[16]}];  # "FMC-LA08_P"
...
set_property -dict {PACKAGE_PIN N18 IOSTANDARD LVCMOS25     IOB TRUE} [get_ports {hdmi_rx_data[0]}];  # "FMC-LA11_N"
set_property -dict {PACKAGE_PIN N17 IOSTANDARD LVCMOS25     IOB TRUE} [get_ports {hdmi_rx_data[2]}];  # "FMC-LA11_P"
set_property -dict {PACKAGE_PIN P21 IOSTANDARD LVCMOS25     IOB TRUE} [get_ports {hdmi_rx_data[3]}];  # "FMC-LA12_N"
set_property -dict {PACKAGE_PIN P20 IOSTANDARD LVCMOS25     IOB TRUE} [get_ports {hdmi_rx_data[4]}];  # "FMC-LA12_P"
#set_property PACKAGE_PIN M17 [get_ports {FMC_LA13_N}];  # "FMC-LA13_N"
#set_property PACKAGE_PIN L17 [get_ports {FMC_LA13_P}];  # "FMC-LA13_P"
set_property -dict {PACKAGE_PIN K20 IOSTANDARD LVCMOS25     IOB TRUE} [get_ports {hdmi_rx_data[12]}];  # "FMC-LA14_N"
set_property -dict {PACKAGE_PIN K19 IOSTANDARD LVCMOS25     IOB TRUE} [get_ports {hdmi_rx_data[1]}];  # "FMC-LA14_P"
set_property -dict {PACKAGE_PIN J17 IOSTANDARD LVCMOS25     IOB TRUE} [get_ports {hdmi_rx_data[11]}];  # "FMC-LA15_N"
set_property -dict {PACKAGE_PIN J16 IOSTANDARD LVCMOS25     IOB TRUE} [get_ports {hdmi_rx_data[13]}];  # "FMC-LA15_P"
set_property -dict {PACKAGE_PIN K21 IOSTANDARD LVCMOS25     IOB TRUE} [get_ports {hdmi_rx_data[14]}];  # "FMC-LA16_N"
set_property -dict {PACKAGE_PIN J20 IOSTANDARD LVCMOS25     IOB TRUE} [get_ports {hdmi_rx_data[15]}];  # "FMC-LA16_P"
...
#set_property PACKAGE_PIN G16 [get_ports {vid_hsync}];  # "FMC-LA19_N"
set_property -dict {PACKAGE_PIN G15 IOSTANDARD LVCMOS25     IOB TRUE} [get_ports {hdmi_rx_data[8]}];  # "FMC-LA19_P"
set_property -dict {PACKAGE_PIN G21 IOSTANDARD LVCMOS25     IOB TRUE} [get_ports {hdmi_rx_data[9]}];  # "FMC-LA20_N"
set_property -dict {PACKAGE_PIN G20 IOSTANDARD LVCMOS25     IOB TRUE} [get_ports {hdmi_rx_data[10]}];  # "FMC-LA20_P"
set_property -dict {PACKAGE_PIN E20 IOSTANDARD LVCMOS25} [get_ports {iic_2_scl_io}];  # "FMC-LA21_N"
#set_property PACKAGE_PIN E19 [get_ports {FMC_LA21_P}];  # "FMC-LA21_P"
#set_property PACKAGE_PIN F19 [get_ports {vid_active_video}];  # "FMC-LA22_N"
#set_property PACKAGE_PIN G19 [get_ports {vid_vsync}];  # "FMC-LA22_P"
...
set_property -dict {PACKAGE_PIN C22 IOSTANDARD LVCMOS25} [get_ports {hdmi_int}];  # "FMC-LA25_N"
set_property -dict {PACKAGE_PIN D22 IOSTANDARD LVCMOS25} [get_ports {iic_2_sda_io}];  # "FMC-LA25_P"
